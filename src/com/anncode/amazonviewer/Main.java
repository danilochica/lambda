...
public class Main {
	...
	public static void showMovies() {
		...
		do {
			...
			movies.forEach(m -> System.out.println(integer.getAndIncrement() + ". " + m.getTitle() + " Visto: " + m.isViewed()));
	...
	public static void makeReport() {
		...
		movies.stream().filter(m ->m.getIsViewed()).forEach(m->contentReport.append(m));;
